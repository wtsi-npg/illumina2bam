...
public class BamMergerTest {
    ...
    public void testOutputBam() throws FileNotFoundException, IOException {
        ...
        assertEquals("757a20138b8d499b958a1d3bcb79e0de", CheckMd5.getBamMd5AfterRemovePGVersion(mergedBamFile, "BamMerger"));
    }
    ...
    public void testMainExtraReadsAtEnd() throws FileNotFoundException, IOException {
        ...
        assertEquals("c248aeec291ad3802dba315ac6c602b7", CheckMd5.getBamMd5AfterRemovePGVersion(mergedBamFile, "BamMerger"));
    }
    ...
    public void testMainExtraReadsAtEndNotKeep() throws FileNotFoundException, IOException {
        ...
        md5File.deleteOnExit();
         ...
         assertEquals("bd54f5431f95ee597f69fa61e111f614", CheckMd5.getBamMd5AfterRemovePGVersion(mergedBamFile, "BamMerger"));
    }
}
