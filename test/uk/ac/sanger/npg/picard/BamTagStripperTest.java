...
public class BamTagStripperTest {
    ...
    public void testOutputBam() throws FileNotFoundException, IOException {
        ...
        md5File.delete();
        assertEquals("9d8e2754e815109d0cc1a235e805451f", CheckMd5.getBamMd5AfterRemovePGVersion(strippedBamFile, "BamTagStripper"));
    ...
    public void testOutputBamKeepCiStrippOQ() throws FileNotFoundException, IOException {
        ...
        File md5File = new File("testdata/7351_8#8_stripped.bam.md5");        
        md5File.delete();
        assertEquals("e745e525e75d6f4a0427e07fcdeec02e", CheckMd5.getBamMd5AfterRemovePGVersion(strippedBamFile, "BamTagStripper"));
        strippedBamFile.delete();
    }    
